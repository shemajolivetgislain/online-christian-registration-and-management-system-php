...
<tbody><tr><td> first Names:<td><input type="text" name="afname"placeholder="firstname"/></td></tr>
<tr><td>last name:</td><td><input type="text" name="alname"placeholder="lastname"/></td></tr>
<tr><td>fathername:</td><td><input type="text" name="afathername"placeholder="your father name"/></td></tr>
<tr><td>mothername:</td><td><input type="text" name="amothername"placeholder="your mother name"/></td></tr>
<tr><td>birth region:</td><td><select  name="region">
...
<tr><td>date of birth</td><td><input type="date" name="aage"placeholder="your age"/></td></tr>
<tr><td>gender:</td><td><select  name="asex">
          <option value="">select your gender
    <option >MALE
    <option >FEMALE

<tr><td>date of baptise:</td><td><input type="date" name="dateofbaptise"placeholder="your gender"/></td></tr>
<tr><td>cell:</td><td><input type="text" name="cell"placeholder="your gender"/></td></tr>
<tr><td>sector:</td><td><input type="text" name="asector"placeholder="yoursector"/></td></tr>
<tr><td>district:</td><td><input type="text" name="adistrict"placeholder="your district"/></td></tr>
