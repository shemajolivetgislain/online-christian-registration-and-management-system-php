...
<table style:"padding-left:-20px;">
	...
	<form action="addchrist2.php" method="POST" enctype="multipart/form-data">
...
<td><input type="date" name="dateofbaptise"placeholder="your gender"/></td></tr>
<tr><td><p>cell:</p></td>
...
<td><input type="text" name="adistrict"placeholder="your district"/></td></tr>
