...
<a href="selectbutare.php" style="font-size:25px;font-weight:bold;text-transform:bold;font-family:century;"><i class="fa fa-list-alt" aria-hidden="true"></i>&nbsp;report</a>
<br>
<p> list of butare christian</p>
<?php
include('dbconnect.php');
$query1=mysql_query("select * from registration where adistrict='huye'");
...
echo "<td><a href='edit4.php?aid=".$query2['aid']."'>Update</a></td>";
