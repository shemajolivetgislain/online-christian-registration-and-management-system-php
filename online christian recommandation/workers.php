...
<table>
<tbody><tr><td> first Names:<td><input type="text" name="fname"placeholder="firstname"title="please enter field"required="required"/></td></tr>
<tr><td>last name:</td><td><input type="text" name="lname"placeholder="lastname"title="please enter field"required="required"/></td></tr>
<tr><td>status:</td><td><input type="text" name="status"placeholder="your father name"title="please enter field"required="required"/></td></tr>
<tr><td>jobstatus:</td><td><input type="text" name="jobstatus"placeholder="your mother name"title="please enter field"required="required"/></td></tr>
<tr><td>gender:</td><td><select  name="sex"title="please enter field"required="required">
          <option value="">select gender
    <option >male
    <option >female
    </select><td></tr>
<tr><td>district:</td><td><select  name="district"title="please enter field"required="required">
...
<tr><td>sector:</td><td><input type="text" name="sector"placeholder="your sector"title="please enter field"required="required"/></td></tr>

<tr><td>umudugudu:</td><td><input type="text" name="umudugudu" placeholder="your umudugudu"title="please enter field"required="required"/></td></tr>
<tr><td>telephone:</td><td><input type="number" name="telephoneno" placeholder="your telephone"title="please enter field"required="required"/></td></tr>
