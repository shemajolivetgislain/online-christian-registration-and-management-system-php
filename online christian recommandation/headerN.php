...
<body>
    ...
    <div id="wallpa">
      ...
      <div id="menutop">
          <ul class="menu">
<li><a href="adminngoma.php"><span><i class="fa fa-home"></i>&nbsp;HOME</span></a></li>
<li><a href="#"><span><i class="fa fa-list"></i>&nbsp;christianlist</span></a>
<ul class="submenu">
<li><a href="listngoma.php"><span><i class="fa fa-list"></i>&nbsp;own list</span></a></li>
</ul>
</li>
<li class="active"><a href="addngoma.php"><span><i class="fa fa-user-plus"></i>&nbsp;addchristian</span></a>
</li>
